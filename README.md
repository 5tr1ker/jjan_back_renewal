...
또한 기능을 확장하고 기존 레거시 코드를 리팩토링할 수 있는 능력도 키울 수 있었습니다.
...
- 사용자 : 회원가입 및 로그인, 사용자 동네 위치 변경, 동네 인증
- 마이페이지 : 프로필 사진 변경 , 회원 정보 수정, 주량 변경
- 모임 : 관심 모임 등록 , 모임 개설 , 모임 목록 및 조회 , 모임 필터링 , 가까운 모임 추천
- 채팅 : 모임 방 마다 실시간 채팅 방
